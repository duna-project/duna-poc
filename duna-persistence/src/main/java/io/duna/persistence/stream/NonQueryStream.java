...
public class NonQueryStream<T> extends LazyWrappedStream<T> implements QueryStream<T> {

    protected InQueryStreamSource inQueryStreamSource;

    public NonQueryStream(Stream<T> wrapped) {
        super(wrapped);
    }

    public NonQueryStream(Stream<T> wrapped, InQueryStreamSource inQueryStreamSource) {
        super(wrapped);
    ...
    public <V> V merge(V entity) {
        if (inQueryStreamSource instanceof NonQueryStreamProvider) {
            ((NonQueryStreamProvider) inQueryStreamSource)
                .getDataSource(entity.getClass())
                .add(entity);
        }
    ...
    protected <U> QueryStream<U> wrap(Stream<U> toWrap) {
        return new NonQueryStream<>(toWrap, inQueryStreamSource);
    }

    @Override
    public <E extends Exception> QueryStream<T> where(Where<T, E> test) {
    ...
    @Override
    public <E extends Exception> QueryStream<T> where(
    ...
    @Override
    public <U> QueryStream<U> select(Select<T, U> select) {
        return wrap(map(val -> select.select(val)));
    }

    @Override
    public <U> QueryStream<U> select(SelectWithSource<T, U> select) {
        return wrap(map(val -> select.select(val, inQueryStreamSource)));
    }

    @Override
    public <U> QueryStream<U> selectAll(Join<T, U> select) {
        return wrap(flatMap(val -> select.join(val)));
    }

    @Override
    public <U> QueryStream<U> selectAll(JoinWithSource<T, U> select) {
        return wrap(flatMap(val -> select.join(val, inQueryStreamSource)));
    }

    @Override
    public <U> QueryStream<U> selectAllList(JoinToIterable<T, U> select) {
        return wrap(flatMap(val -> StreamSupport.stream(select.join(val).spliterator(), false)));
    }

    @Override
    public <U> QueryStream<Pair<T, U>> join(Join<T, U> join) {
    ...
    @Override
    public <U> QueryStream<Pair<T, U>> join(JoinWithSource<T, U> join) {
        // TODO: This stream should be constructed on the fly
        final Stream.Builder<Pair<T, U>> streamBuilder = Stream.builder();
        forEach(left -> {
    ...
    @Override
    public <U> QueryStream<Pair<T, U>> joinList(
    ...
    @Override
    public <U> QueryStream<Pair<T, U>> leftOuterJoin(Join<T, U> join) {
        // TODO: This stream should be constructed on the fly
        final Stream.Builder<Pair<T, U>> streamBuilder = Stream.builder();
        forEach(left -> {
    ...
    @Override
    public <U> QueryStream<Pair<T, U>> leftOuterJoinList(
        org.jinq.orm.stream.JinqStream.JoinToIterable<T, U> join) {
        // TODO: This stream should be constructed on the fly
        final Stream.Builder<Pair<T, U>> streamBuilder = Stream.builder();
        forEach(left -> {
    ...
    @Override
    public <U> QueryStream<Pair<T, U>> leftOuterJoin(JoinWithSource<T, U> join, WhereForOn<T, U> on) {
        // TODO: This stream should be constructed on the fly
        final Stream.Builder<Pair<T, U>> streamBuilder = Stream.builder();
        forEach(left -> {
    ...
    @Override
    public <U> QueryStream<Pair<T, U>> crossJoin(JinqStream<U> join) {
    ...
    protected <U, W extends Tuple> QueryStream<W> groupToTuple(Select<T, U> select,
                                                              AggregateGroup<U, T, ?>[] aggregates) {
    ...
    @Override
    public <U, V> QueryStream<Pair<U, V>> group(Select<T, U> select, AggregateGroup<U, T, V> aggregate) {
    ...
    @Override
    public <U, V, W> QueryStream<Tuple3<U, V, W>> group(
    ...
    @Override
    public <U, V, W, X> QueryStream<Tuple4<U, V, W, X>> group(
        JinqStream.Select<T, U> select,
        JinqStream.AggregateGroup<U, T, V> aggregate1,
        JinqStream.AggregateGroup<U, T, W> aggregate2,
    ...
    @Override
    public <U, V, W, X, Y> QueryStream<Tuple5<U, V, W, X, Y>> group(
        JinqStream.Select<T, U> select,
        JinqStream.AggregateGroup<U, T, V> aggregate1,
        JinqStream.AggregateGroup<U, T, W> aggregate2,
        JinqStream.AggregateGroup<U, T, X> aggregate3,
    ...
    @Override
    public <U, V, W, X, Y, Z> QueryStream<Tuple6<U, V, W, X, Y, Z>> group(
    ...
    @Override
    public <U, V, W, X, Y, Z, A> QueryStream<Tuple7<U, V, W, X, Y, Z, A>> group(
        Select<T, U> select, AggregateGroup<U, T, V> aggregate1,
        AggregateGroup<U, T, W> aggregate2, AggregateGroup<U, T, X> aggregate3,
        AggregateGroup<U, T, Y> aggregate4, AggregateGroup<U, T, Z> aggregate5,
    ...
    @Override
    public <U, V, W, X, Y, Z, A, B> QueryStream<Tuple8<U, V, W, X, Y, Z, A, B>> group(
        Select<T, U> select, AggregateGroup<U, T, V> aggregate1,
        AggregateGroup<U, T, W> aggregate2, AggregateGroup<U, T, X> aggregate3,
        AggregateGroup<U, T, Y> aggregate4, AggregateGroup<U, T, Z> aggregate5,
    ...
    public <V extends Number & Comparable<V>> Double avg(CollectNumber<T, V> aggregate) {
        final NonQueryStream.GenericAverage avg = new NonQueryStream.GenericAverage();
...
//
    @Override
    public <V extends Comparable<V>> QueryStream<T> sortedBy(
    ...
    @Override
    public <V extends Comparable<V>> QueryStream<T> sortedDescendingBy(
        JinqStream.CollectComparable<T, V> sortField) {
        return wrap(sorted(
            (o1, o2) -> -sortField.aggregate(o1).compareTo(sortField.aggregate(o2))));
    }
    ...
    @Override
    public QueryStream<T> limit(long n) {
...
//   }
    ...
    <U extends Tuple> U multiaggregate(AggregateSelect<T, ?>[] aggregates) {
        NonQueryJinqStream.IteratorTee<T> tee = new NonQueryJinqStream.IteratorTee<>(this, aggregates.length);
    ...
    @Override
    public QueryStream<T> setHint(String name, Object value) {
        return this;
    }
}
